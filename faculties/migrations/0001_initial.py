    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, null=True, verbose_name='Контентная часть')),
                ('content_ru', models.TextField(blank=True, null=True, verbose_name='Контентная часть')),
                ('content_en', models.TextField(blank=True, null=True, verbose_name='Контентная часть')),
                ('content_kk', models.TextField(blank=True, null=True, verbose_name='Контентная часть')),
